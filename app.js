...
{
    res.sendFile('BloodWebsite1.html', {root:path.join(__dirname,'./public/html')});
});


app.get('/AboutBloodGroup.html',function(req,res)
{
    res.sendFile('AboutBloodGroup.html', {root:path.join(__dirname,'./public/html')});
});

app.get('/BloodDonators.html',function(req,res)
{
    res.sendFile('BloodDonators.html', {root:path.join(__dirname,'./public/html')});
});
